...
public class StylusGestures extends SettingsPreferenceFragment implements
    ...
    public static final String KEY_GESTURES_CATEGORY = "gestures_category";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!hasStylusSwitch()) {
            Preference preference = findPreference(KEY_GESTURES_CATEGORY);
            if (preference != null && preference instanceof PreferenceCategory) {
                PreferenceCategory preferenceCategory = (PreferenceCategory) preference;
                preferenceCategory.removePreference(mSpenRemove);
                preferenceCategory.removePreference(mSpenInsert);
            }
        }
    }
    ...
    /**
     * Populate the list with available application to list
     * @param pref
     * @param packageName
     * @param noBack true for removing emulate back key action
     * back action cause issue s-pen due to broadcast receiver leaking
     */
    private void addApplicationEntries(ListPreference pref, String packageName, boolean noBack) {
        ...
        if(noBack){
           int index= entryList.indexOf(resources.getString(R.string.gestures_action_back));
           entryList.remove(index);
           entryListValue.remove(index);
        }
