...
public class Settings extends PreferenceActivity
    ...
    private static class HeaderAdapter extends ArrayAdapter<Header> {
        ...
        static int getHeaderType(Header header) {
            if (header.fragment == null && header.intent == null && header.id != R.id.holobam_settings) {
                return HEADER_TYPE_CATEGORY;
            } else if (header.id == R.id.wifi_settings
                    || header.id == R.id.bluetooth_settings
                    || header.id == R.id.profiles_settings
                    || header.id == R.id.holobam_settings) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (headerType) {
                ...
                case HEADER_TYPE_SWITCH:
                    ...
                    } else if (header.id == R.id.holobam_settings) {
    ...
    public void onHeaderClick(Header header, int position) {
        ...
        if (header.id == R.id.holobam_settings) {
            mTRDSSwitch.toggle();
        }
    }
    ...
    public static class BamModderSoundsSettingsActivity extends Settings { /* empty */ }
    public static class BamModderGraphicssSettingsActivity extends Settings { /* empty */ }
